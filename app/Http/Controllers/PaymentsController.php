...
use SisConPat\Repositories\PaymentRepository;
use SisConPat\Repositories\PaymentReasonRepository;
use SisConPat\Repositories\PaymentMethodRepository;
...
class PaymentsController extends Controller
{
    ...
    public function import(Requests\PaymentImportRequest $request, MemberRepository $memberRepository)
    {
        ...
        $row_counter = 0;
        $row_counter_errors = 0;
        $row_member_code_errors = "";

        $members = $this->memberRepository->allMembers();
        ...
        while ($row = $payment_file_content->getRow()) 
        {
            ...
            if($members->contains('code', $member_code))
            {
               dd($member->id)
            }
            ...
            #    $row_member_code_errors .= $member_code.' ';
            #}
        }
