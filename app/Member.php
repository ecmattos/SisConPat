...
class Member extends Revisionable
{
    ...
    {
        return $this->belongsTo('SisConPat\MemberStatus');  
    }

    public function plan()
    {
        return $this->belongsTo('SisConPat\Plan');   
    }

    public function gender()
    {
        return $this->belongsTo('SisConPat\Gender');   
    }

    public function member_status_reason()
    {
        return $this->belongsTo('SisConPat\MemberStatusReason');   
    }

    public function bank()
    {
        return $this->belongsTo('SisConPat\Bank'); 
    }

    public function payments()
    {
        return $this->hasMany('SisConPat\Payment'); 
    }
}
