...
class AccountingAccount extends Revisionable
{
    ...
    {
        return $this->belongsTo('SisConPat\AccountType');   
    }
    ...
    {
        return $this->belongsTo('SisConPat\PatrimonilSubType', 'asset_accounting_accont_id');   
    }

    public function balance_sheet()
    {
        return $this->belongsTo('SisConPat\BalanceSheet');   
    }

    public function balance_sheet_previous()
    {
        return $this->belongsTo('SisConPat\BalanceSheetPrevious');   
    }
}